...
在全屏模式下，可以执行代码并且将代码的输入输出框切换为`双栏/单栏`显示

点击右上角`退出全屏`将回到Notebook文档页面


![图 35](../images/whole.gif)  
...
- `Insert Code Cell`:鼠标移动至单元格的下边界处显示该菜单，点击在下方增加一个默认类型的单元格
- `More cell types`：鼠标移动至单元格的下边界处显示该菜单，选择所需增加的单元格类型
